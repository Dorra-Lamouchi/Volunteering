...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   ...
   <img src="images/groupe 4.png" style="margin:0; padding:0; position: relative; height: 110%; width: 100%;" >
                ...
                <div class="container">
                 <div class="row">
                    ...
                    <a href="/register" style="border:none; background:none; position: relative; top:-200px; right:-20px">
                    <img src=" images/groupe 3.png" > 
                    </a>
                    </div>
                 </div>
                </div>
